...
class Player():
    ...
    def still_has_cards(self):
        return len(self.hand.cards) != 0 # returning true if cards in hand

#View part of Game play
...
print("Does the Human player have cards >")
print(str(user.still_has_cards()))
if comp.still_has_cards() and not user.still_has_cards():
    print("Hurry! Computer is win")
else:
    print("Congratulations {} you are winner".format(user.name))
